package cn.com.study.pool2.socket.clients.util;
...
import cn.com.study.pool2.socket.clients.socket.exceptions.SocketClientException;
...
public abstract class Pool<T> implements Closeable {
	...
	protected void closeInternalPool() {
		try {
			...
			throw new SocketClientException("Could not destroy the pool", e);
		}
	}
	...
	public void addObject(int count) {
		try {
			...
			throw new SocketClientException("Error trying to add idle objects", e);
		}
	}
